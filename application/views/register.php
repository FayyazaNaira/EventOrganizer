  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <?php echo form_open('register/save')?>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" name="password" placeholder="Password" maxlength="200" required>
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <a href="<?php echo base_url('index.php/login')?>" class="text-center text-primary">I already have a membership</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
