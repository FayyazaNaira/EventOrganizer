            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item disabled"><a href="<?php echo base_url('index.php/kategoripeserta/update?id='.$katpeserta_update->id)?>">Update</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card  card-success card-outline">
            ...
            <div class="card-body">
                ...
                <?php $hidden = ['idedit'=>$katpeserta_update->id]; ?>
                <?php echo form_open('kategoripeserta/create','kategorikegiatan',$hidden)?>
