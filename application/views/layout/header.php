...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      ?>
      <li class="nav-item d-none d-sm-inline-block">
      <a href= "<?php echo base_url('/index.php/kategoripeserta')?>" class="nav-link">Kategori Peserta</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
      ...
      <li class="nav-item d-none d-sm-inline-block">
      <a href= "<?php echo base_url('/index.php/jeniskegiatan')?>" class="nav-link">Jenis Kegiatan</a>
      </li>
      <?php
      }
      ?>
